...
func Test_ExtractHTMLRangeFlat(t *testing.T) {
	...
	t.Run("test html extraction", func(t *testing.T) {
		...
		c.OnHTML("#all", func(h *colly.HTMLElement) {
			theDom = h.DOM
			result = MpExtractHTMLRangeFlat(theDom, "p:first-of-type", "")
		})
		...
		// return unclipped
		//----------------------------------------
		result = MpExtractHTMLRangeFlat(theDom, "", "")
		...
		//----------------------------------------
		result = MpExtractHTMLRangeFlat(theDom, "", "#nasty-ads")
		...
		//----------------------------------------
		result = MpExtractHTMLRangeFlat(theDom, "p:first-of-type", "#nasty-ads")
