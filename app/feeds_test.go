...
func Test_ExtractHTMLRangeFlat(t *testing.T) {
	...
	t.Run("test html extraction", func(t *testing.T) {
		...
		c.OnHTML("#all", func(h *colly.HTMLElement) {
			theDom = h.DOM
			result = _extractHTMLRange(theDom, "p:first-of-type", "")
		})
		...
		// return unclipped
		//----------------------------------------
		result = _extractHTMLRange(theDom, "", "")
		...
		//----------------------------------------
		result = _extractHTMLRange(theDom, "", "#nasty-ads")
		...
		//----------------------------------------
		result = _extractHTMLRange(theDom, "p:first-of-type", "#nasty-ads")
